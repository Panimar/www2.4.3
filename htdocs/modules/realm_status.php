...
<?php
// MySQL settings
$WoWHostname = "wowwnet.servegame.com"; // MySQL server address
$WoWUsername = "webwow"; // MySQL username
$WoWPassword = "iomegatuning"; // MySQL password
$CharacterDatabase = 'cha'; // TC characters database
$RealmDatabase = 'realmd'; // TC relamd database
$WorldDatabase = 'mangos'; // TC world database
...
if ($gamebuild_results['gamebuild'] > '11403') {
	$gamebuild = "2.4.3 (" .$gamebuild_results['gamebuild']. ")";
}
else {
